program p5_dp
    ...
    open(100, file='integrales_punto_medio_pr_doble.dat', status='replace')
    ...
    do k=0,9
        ...
        Error_PuntoMedio1=abs(I_exacta_1-I_PuntoMedio1)
    ...
    open(101,file='integrales_trapecio_pr_doble.dat',status='replace')
    write(101,12)'Numero de Puntos','Trapecio','Error','h'
    ...
    do k=0,9
        ...
        Error_Trapecio1=abs(I_exacta_1-I_Trapecio1)
    ...
    open(102,file='integrales_simpson_pr_doble.dat',status='replace')
    ...
    do k=0,9
        ...
        Error_Simpson1=abs(I_exacta_1-I_Simpson1)
