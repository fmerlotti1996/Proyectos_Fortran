...
INTEGER(pr)                 :: k
REAL(pr)                    :: h,fp, fp_exacto, error_abs
...
OPEN(UNIT=11,FILE='datos_P2.dat',status='replace')
...
fp_exacto=df(2._pr)
    ...
    DO k=1,30
        ...
        error_abs=abs(fp_exacto-df_5p(2._pr,h,f))

        WRITE(11,13) h, df_5p(2._pr,h,f), fp_exacto, error_abs
