...
SUBROUTINE  biseccion(a,b,xtol,ytol,p_out,fp_out,N,Nmax,error_est_out)
...
REAL(pr),INTENT(out)        :: p_out,fp_out,error_est_out ! VARIABLES DE SALIDA QUE VAN AL PROGRAMA PRINCIPAL 

OPEN(unit = 11, file ='problema4_bisec.dat',status='replace')
