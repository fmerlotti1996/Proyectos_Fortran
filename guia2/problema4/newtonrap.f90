...
SUBROUTINE  newtonrapshon(p0,xtol,ytol,p_out,fp_out,N,Nmax,error_est_out)

IMPLICIT NONE

INTEGER                  :: N,i 
REAL(pr)                 :: p,fp0,fd0,error_x,error_y
REAL(pr),INTENT(inout)   :: p0,xtol,ytol,error_est_out,Nmax
REAL(pr),INTENT(out)     :: p_out,fp_out 

OPEN(11,FILE='problema4_newtonrap.dat',STATUS='replace')
...
WRITE(*,12) '#', 'N', 'p', 'f(p)' ,'Er_R(x)', 'Er_A(y)'
WRITE(11,12) '#', 'N', 'p','f(p)', 'Er_R(x)', 'Er_A(y)'
